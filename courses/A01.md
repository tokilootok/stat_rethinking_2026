...
$$ \begin{aligned} W &\sim \operatorname{Binomial}(N,p)\\ p &\sim \operatorname{Beta}(\alpha,\beta) \end{aligned} $$

### Posterior

$$ p \mid W,N \sim \operatorname{Beta}(\alpha+W,\beta+N-W) $$
...
$$ p \mid W,N \sim \operatorname{Beta}(W+1,N-W+1) $$
...
$$ W^{(s)} \sim \operatorname{Binomial}(N,p^\star) $$
