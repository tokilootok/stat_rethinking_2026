...
\text{priors}
\rightarrow
\text{posterior event probabilities or rates}
\rightarrow
\text{scientific contrasts}
$$
...
\text{coefficient}
\neq
\text{effect on the observed event scale in general}
$$
...
$$
\mathbb{E}[Y_i \mid N_i,p_i]
=
N_i p_i
$$

$$
\operatorname{Var}(Y_i \mid N_i,p_i)
=
N_i p_i(1-p_i)
$$
...
$$
\text{prior on coefficient}
\rightarrow
\text{prior on probability}
$$
...
$$
\frac{
\operatorname{odds}(p_{x+1})
}{
\operatorname{odds}(p_x)
}
=
\exp(\beta)
$$
...
A_{gd}
\sim
\operatorname{Binomial}(N_{gd},p_{gd})
$$
...
\Delta_{\mathrm{total}}
=
\operatorname{logit}^{-1}(\alpha_1)
-
\operatorname{logit}^{-1}(\alpha_2)
$$
...
\Delta_d
=
\operatorname{logit}^{-1}(\alpha_{1d})
-
\operatorname{logit}^{-1}(\alpha_{2d})
$$
...
w_d
=
\frac{N_d}{\sum_{k=1}^{6}N_k}
$$

Then:

$$
\Delta_{\mathrm{weighted}}
=
\sum_{d=1}^{6}
w_d \Delta_d
$$
...
$$
\mathbb{E}[Y_i \mid \lambda_i]
=
\lambda_i
$$

$$
\operatorname{Var}(Y_i \mid \lambda_i)
=
\lambda_i
$$
...
=
\frac{
\log(\operatorname{population}_i)-\overline{\log P}
}{
s_{\log P}
}
$$
...
\neq
\text{mechanistic process model automatically}
$$
...
\text{identification}
\rightarrow
\text{conditional event model}
\rightarrow
\text{intervention prediction}
\rightarrow
\text{standardization}
\rightarrow
\text{contrast}
